...
Then, wait for the CIs (CircleCI & AppVeyor) to build the artefacts needed for the release (MacOS, Windows and Linux)

Once finished, you can download them and upload them to the new release!
